...
namespace LIT.Smabu.UseCases.Payments
{
    public static class CreatePayment
    {
        ...
        public class CreatePaymentHandler(IUnitOfWork uow, BusinessNumberService businessNumberService, FinancialRelationsService financialRelationsService)
            : ICommandHandler<CreatePaymentCommand, PaymentId>
        {
            public async Task<Result<PaymentId>> Handle(CreatePaymentCommand request, CancellationToken cancellationToken)
            {
                ...
                await uow.Repository.CreateAsync(payment);
                return payment.Id;
            }
