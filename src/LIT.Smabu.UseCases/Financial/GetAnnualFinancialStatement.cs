...
namespace LIT.Smabu.UseCases.Financial
{
    public static class GetAnnualFinancialStatement
    {
        ...
        public class GetAnnualFinancialStatementHandler(IAggregateCache cache) : IQueryHandler<GetAnnualFinancialStatementQuery, AnnualFinancialStatementDTO>
        {
            ...
            {
                AnnualFinancialStatement annualFinancialStatement = await cache.GetByAsync(request.AnnualFinancialStatementId);
