...
namespace LIT.Smabu.UseCases.Financial
{
    public static class CompleteAnnualFinancialStatement
    {
        ...
        public class CompleteAnnualFinancialStatementHandler(IUnitOfWork uow) : ICommandHandler<CompleteAnnualFinancialStatementCommand>
        {
            ...
            {
                Payment[] paymentsForFiscalYear = await uow.Repository.ApplySpecificationTask(new PaymentsForFiscalYearSpec(financialStatement.FiscalYear));
